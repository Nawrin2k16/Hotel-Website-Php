...
<div id="contact" class="w3-modal">
  <div class="w3-modal-content w3-animate-zoom">
    ...
    <div class="w3-container">
      <p>Room delivery service, ask for today's special or just send us a message:</p>
      <form action="/action_page.php" target="_blank">
        ...
        <p><input class="w3-input w3-padding-16 w3-border" type="datetime-local" placeholder="Date and time" required name="date" value=<?php 
        echo date("d:m:y");
        ?>></p>
...
if(isset($_COOKIE['userc'])) {
  ...
  ?>
		<p> <h2><button><a href="restaurant.php?logout='1'" style="color: red;">logout</a> </button></h2></p>
